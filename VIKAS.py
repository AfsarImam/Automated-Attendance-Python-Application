...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('C:\\Users\\HP\\Downloads\\Automated-Attendance-Python-Application-main\\Automated-Attendance-Python-Application-main\\StudentDetails\\StudentDetails.csv', 'a', newline='') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = 'C:/Users/HP/Downloads/Automated-Attendance-Python-Application-main/Automated-Attendance-Python-Application-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen('explorer "C:\\Users\\HP\\Downloads\\Automated-Attendance-Python-Application-main\\Automated-Attendance-Python-Application-main\\Attendance"')
...
text1="Welcome to QUINTENT  :)    **when moving to other windows, do not close this main window!" 
